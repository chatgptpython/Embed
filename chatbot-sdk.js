        ...
        <div id="chatbot">
            <header>
                <div class="icon-container">
                    <img src="https://raw.githubusercontent.com/chatgptpython/embed/main/nfc-direct-removebg-preview.png">
                </div>
...
window.typeWelcomeMessage = async function() {
    ...
    botAvatar.className = "bot-avatar112";
        ...
        setTimeout(() => {
            ...
            .then(data => {
                ...
                messageContainer.innerHTML = `
                    <img src="https://github.com/chatgptpython/embed/blob/main/robot-assistant.png?raw=true" alt="Bot Avatar" class="bot-avatar112">
                `;
                chatContent.appendChild(messageContainer);
                let messageElem = document.createElement("div");
                messageElem.className = "bot-message";
