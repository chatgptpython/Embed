...
#chatbot-text {
    position: fixed;
    bottom: 200px; /* Aanzienlijk vergroot om de balk veel lager te plaatsen */
    right: 30px;
    font-size: 15px;
    background-color: #ffffff;
    color: #000000;
...
#chatbot-text-close {
    position: absolute;
    top: -50px; /* Aanzienlijk vergroot om het kruisje veel lager te plaatsen */
    right: -10px;
    background-color: #ffffff;
    color: #000000;
    border: 1px solid rgba(0, 0, 0, 0.1);
        ...
        <div id="chatbot">
            <header>
                <div class="icon-container">
                    <img src="https://raw.githubusercontent.com/chatgptpython/embed/main/icoon.png" alt="Icon" id="header-icon">
